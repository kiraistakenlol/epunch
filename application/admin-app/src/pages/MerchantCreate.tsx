...
import { CreateMerchantDto } from 'e-punch-common-core';
...
export const MerchantCreate: React.FC = () => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      showSnackbar('Merchant created successfully', 'success');
      ...
      showSnackbar(err.message || 'Failed to create merchant', 'error');
    } finally {
