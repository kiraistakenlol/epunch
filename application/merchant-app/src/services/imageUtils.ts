...
import { punchCardPreviewService } from './punchCardPreview';
...
const generateBannerHTML = (
  ...
  const cardContent = cardImageDataUrl ? `
    <div style="
      width: 350px;
      height: 280px;
      display: flex;
    ...
    ">
      <div style="
        ...
        align-items: center;
      ">
        <span style="font-weight: bold; font-size: 1.1rem;">${merchantName}</span>
      </div>
...
export const generateOnboardingImage = async (
  ...
  tempContainer.innerHTML = generateBannerHTML(
    title,
    titleColor,
    backgroundColor,
