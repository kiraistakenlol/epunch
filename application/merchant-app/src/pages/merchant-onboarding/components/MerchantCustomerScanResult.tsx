      ...
      <Card className="flex-1 flex flex-col text-xs">
        <CardHeader className="pb-3 px-3 py-3">
          <div className="flex items-center justify-center space-x-2 mb-2">
            ...
            <Badge variant="outline" className="text-xs px-2 py-0">Customer</Badge>
          </div>
          <CardTitle className="text-sm text-center">Ready to Punch</CardTitle>
        </CardHeader>
          ...
          <div className="flex-1">
            ...
            >
              ...
              <p className="text-xs text-muted-foreground">
                Current: {currentPunches}/{totalPunches}
              </p>
            </div>
          </div>
