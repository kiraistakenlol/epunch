...
APP_DATA.eventText = function(event, lang) {
  ...
  if (!card) return "";
  const shop = (card.shopNameI18n && card.shopNameI18n[lang]) || card.shopName;
...
(function() {
  ...
  } else if (state === 'handout') {
    APP_DATA.cards = [
      {
        id: "punch-1", type: "punch", shopName: "Your Business",
        shopNameI18n: { en: "Your Business", es: "Tu negocio", ru: "Ваш бизнес", zh: "您的商户" },
        ...
        rewardI18n: { en: "1 free item of your choice", es: "1 artículo gratis", ru: "1 бесплатный товар", zh: "免费获得1件商品" },
        current: 5, total: 8, accent: "#FF385C", emoji: "\u2605"
      },
      {
        id: "punch-2", type: "punch", shopName: "Your Business",
        shopNameI18n: { en: "Your Business", es: "Tu negocio", ru: "Ваш бизнес", zh: "您的商户" },
        ...
        current: 6, total: 6, accent: "#008A05", emoji: "\u2666"
      }
    ];
    APP_DATA.feedEvents = [];
    APP_DATA.user = { id: "EP-2F9A-4C71-8B3E", name: "Maria G.", email: "maria@example.com", authenticated: true, qrSeed: 0xABCDEF12 };
  }
})();
